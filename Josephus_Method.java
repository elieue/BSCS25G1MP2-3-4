...
public class Josephus_Method {
    ...
    public static void main(String[] args) {
        ...
        char tryAgainChoice; // This variable needs to be declared here for the loop
        ...
        do {
            ...
            // Read the user input
            tryAgainChoice = scan.next().charAt(0);
            scan.nextLine(); 

        // This is the while part of the loop. It checks the user input if it wants to try again
        } while (tryAgainChoice == 'Y' || tryAgainChoice == 'y');

        scan.close(); // Closes the scanner to avoid error
        System.out.println("Thank you for using the Josephus Method simulator!");
    }
